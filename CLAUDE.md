...
- **Short, cohesive methods**: when a function exceeds roughly 100 lines, or its body nests past three levels, extract cohesive phases into private helpers. Each helper should do one thing and have a signature narrow enough to test in isolation.
